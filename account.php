...
if(isset($_POST['savebtn'])){
    $account = $r_user['account'];
    $avatar = $_POST['avatar'];
    $email = $_POST['email'];
    $newpass = $_POST['password'];
    
    if (isset($account) && isset($avatar) && isset($email)){
        ...
        echo '
                            <div  aria-live="polite" aria-atomic="true" class="toast-container position-absolute  top-0 start-50 translate-middle-x p-3">
                                ...
                                <div id="liveToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
                                   ...
                                   Bạn nhập không đúng fortmat email.
                                    </div>
                                </div>
                            </div>';
        ...
        if($sql1 == 0){
                if($newpass == ""){
                    ...
                    if($newpass > 7){
                        echo '
                            <div  aria-live="polite" aria-atomic="true" class="toast-container position-absolute  top-0 start-50 translate-middle-x p-3">
                                ...
                                <div id="liveToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
                                    ...
                                    <div class="toast-body">
                                   Mật khẩu của bạn phải trên 7 ký tự.
                                    </div>
                                </div>
                            </div>';
                        ...
                        $newpass = md5($newpass);
                        $query = mysqli_query($conn, "UPDATE `user` SET `avatar`='$avatar',`email`='$email', `pass`='$newpass' WHERE `account`= '$account'");
                        if($query){
                            echo '<script>window.location.href="account.php";</script>';
